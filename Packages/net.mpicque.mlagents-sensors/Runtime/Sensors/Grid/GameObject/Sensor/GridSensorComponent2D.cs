...
namespace Sensors.Grid
{
    ...
    public class GridSensorComponent2D : GridSensorComponentBaseGO
    {
        ...
        [SerializeField]
        [OnValueChanged(nameof(OnRotationTypeChange))]
        [Foldout("Geometry")]
        ...
        [SerializeField]
        [OnValueChanged(nameof(OnCellSizeChange))]
        [Foldout("Geometry")]
        ...
        [SerializeField]
        [OnValueChanged(nameof(OnNumCellsChange))]
        [Foldout("Geometry")]
        ...
        [SerializeField]
        [OnValueChanged(nameof(OnBoundsSizeChange))]
        [Foldout("Geometry")]
        ...
        [SerializeField]
        [OnValueChanged(nameof(OnOffsetChange))]
        [Foldout("Geometry")]
